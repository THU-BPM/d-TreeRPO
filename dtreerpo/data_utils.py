...
def get_gsm8k_questions(split="train") -> Dataset:
    ...
    return data.map(
        lambda x: {
            "prompt": [
                {"role": "user", "content": SYSTEM_PROMPT + "You are a math expert. You will be given a question to solve. Solve it step by step. Put only the final answer (the number) in the <answer> </answer> tag without any other text.\n\n"+ x["question"]},
            ],
